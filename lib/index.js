...
_http2['default'].createServer(function (req, res) {
  ...
  if (path === '/question') res.write(question());else if (path === '/answer') res.write(answer());else if (path === '/pick') res.write(JSON.stringify(pick()));else res.write('loaderio-2bc3a09986d3d7ae3640b3fa3808459b');//else res.write('USAGE:\n               /question - get a random white card\n               /answer - get a random black card\n               /pick - get a question and answer randomly chosen');
