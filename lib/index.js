...
_http2['default'].createServer(function (req, res) {
  ...
  if (path === '/question') res.write(question());else if (path === '/answer') res.write(answer()); else if (path === '/loaderio-6a783276f4259dff6328df708439e2bf') res.write('loaderio-6a783276f4259dff6328df708439e2bf');else if (path === '/pick') res.write(JSON.stringify(pick()));else res.write('USAGE:\n               /question - get a random white card\n               /answer - get a random black card\n               /pick - get a question and answer randomly chosen');
